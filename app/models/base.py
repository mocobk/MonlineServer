...
from app.extensions import flask_ma, db
...
# flask_marshmallow::SQLAlchemyAutoSchemaOpts
...
class SQLAlchemyAutoSchema(flask_ma.SQLAlchemyAutoSchema, Schema):  # type: Schema
    """
    orm 模型序列化基类, 这里重复继承了 Schema 主要是为了实现 Type Hinting
